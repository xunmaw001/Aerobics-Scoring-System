...
import center from '@/views/center'
    ...
    import discussjianmeicao from '@/views/modules/discussjianmeicao/list'
    import jianmeicao from '@/views/modules/jianmeicao/list'
...
const routes = [{
	...
	path: '/yonghu',
      ...
      ,{
	path: '/discussjianmeicao',
        name: '健美操评论',
        component: discussjianmeicao
      }
      ,{
	path: '/jianmeicao',
        name: '健美操',
        component: jianmeicao
      }
      ,{
	path: '/pingfen',
        name: '评分',
