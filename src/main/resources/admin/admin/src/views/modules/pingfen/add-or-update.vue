	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px 0","background":"url(http://codegen.caihongy.cn/20230328/e3b3ef59d7a44ae6afcff886f7a76b98.jpg) no-repeat center bottom / 100% 100%","height":"auto"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="编号" prop="bianhao">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="裁判账号" prop="caipanzhanghao">
					<el-input v-model="ruleForm.caipanzhanghao" placeholder="裁判账号" clearable  :readonly="ro.caipanzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="裁判账号" prop="caipanzhanghao">
					<el-input v-model="ruleForm.caipanzhanghao" placeholder="裁判账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="裁判员" prop="caipanyuan">
					<el-input v-model="ruleForm.caipanyuan" placeholder="裁判员" clearable  :readonly="ro.caipanyuan"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="裁判员" prop="caipanyuan">
					<el-input v-model="ruleForm.caipanyuan" placeholder="裁判员" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="评分" prop="pingfen">
					<el-input v-model="ruleForm.pingfen" placeholder="评分" clearable  :readonly="ro.pingfen"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="评分" prop="pingfen">
					<el-input v-model="ruleForm.pingfen" placeholder="评分" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="评语" prop="pingyu">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.pingyu" label="评语" prop="pingyu">
					<span :style='{"fontSize":"16px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.pingyu}}</span>
				</el-form-item>
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					var json = data.data;
					if(((json.caipanzhanghao!=''&&json.caipanzhanghao) || json.caipanzhanghao==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.caipanzhanghao = json.caipanzhanghao
						this.ro.caipanzhanghao = true;
					}
					if(((json.caipanyuan!=''&&json.caipanyuan) || json.caipanyuan==0) && this.$storage.get("role")!="管理员"){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `pingfen/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.pingfenCrossAddOrUpdateFlag = false;
						 this.parent.search();
