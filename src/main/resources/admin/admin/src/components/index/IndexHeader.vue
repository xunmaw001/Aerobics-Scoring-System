<template>
	<div class="navbar">
		<div class="title" :style='{"display":"block","height":"44px"}'>
			...
			<span class="title-name" :style='{"padding":"0px","lineHeight":"44px","fontSize":"24px","color":"#7e7a59","float":"left","fontWeight":"600"}'>{{this.$project.projectName}}</span>
		</div>
		<div class="right" :style='{"fontSize":"16px","position":"absolute","right":"20px","top":"8px","display":"flex"}'>
			...
			<div :style='{"cursor":"pointer","margin":"0 5px","lineHeight":"44px","color":"#333"}' v-if="this.$storage.get('role')!='管理员'" class="logout" @click="onIndexTap">退出到前台</div>
