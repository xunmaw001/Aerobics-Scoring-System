...
<div class="recommend" :style='{"margin":"20px auto 0","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230130/d81fd2d44f4e475eb1c571b1f64e5fae.png) no-repeat center top","display":"flex","width":"100%","position":"relative","justifyContent":"center"}'>
    ...
    <div class="title" :style='{"margin":"50px 7% 80px","alignItems":"flex-start","textAlign":"center","background":"none","display":"flex","width":"50%","position":"relative","justifyContent":"center","height":"76px"}'>
		<span :style='{"margin":"0 10px 0 0","fontSize":"32px","color":"#202020","textAlign":"center","fontWeight":"600"}'>健美操推荐</span>
	</div>
	...
	<div class="list list4 index-pv1" :style='{"width":"100%","padding":"20px 7% 40px","background":"none","height":"auto"}'>
		<div v-if="jianmeicaoRecommend.length>0" class="list-item animation-box" @click="toDetail('jianmeicaoDetail', jianmeicaoRecommend[0])" :style='{"width":"48%","margin":"0","position":"relative","float":"right","height":"570px"}'>
			<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-if="preHttp(jianmeicaoRecommend[0].fengmian)" :src="jianmeicaoRecommend[0].fengmian.split(',')[0]" alt="" />
			<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-else :src="baseUrl + (jianmeicaoRecommend[0].fengmian?jianmeicaoRecommend[0].fengmian.split(',')[0]:'')" alt="" />
			<div class="title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","left":"0","textAlign":"center","bottom":"0","background":"rgba(0,0,0,.3)","width":"100%","lineHeight":"32px","fontSize":"14px","position":"absolute","textOverflow":"ellipsis"}'>
                <div>{{jianmeicaoRecommend[0].shipinbiaoti}}</div>
                <div>{{jianmeicaoRecommend[0].shipinfenlei}}</div>
            </div>
		</div>
		<div class="list-body" :style='{"width":"48%","margin":"0 0 10px","float":"left","justifyContent":"space-between","display":"flex","height":"275px"}'>
			<div v-if="jianmeicaoRecommend.length>1" @click="toDetail('jianmeicaoDetail', jianmeicaoRecommend[1])" class="list-item animation-box" :style='{"width":"48%","margin":"0","position":"relative","display":"inline-block","height":"100%"}'>
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-if="preHttp(jianmeicaoRecommend[1].fengmian)" :src="jianmeicaoRecommend[1].fengmian.split(',')[0]" alt="" />
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-else :src="baseUrl + (jianmeicaoRecommend[1].fengmian?jianmeicaoRecommend[1].fengmian.split(',')[0]:'')" alt="" />
				<div class="title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","left":"0","textAlign":"center","bottom":"0","background":"rgba(0,0,0,.3)","width":"100%","lineHeight":"32px","fontSize":"14px","position":"absolute","textOverflow":"ellipsis"}'>
                    <div>{{jianmeicaoRecommend[1].shipinbiaoti}}</div>
                    <div>{{jianmeicaoRecommend[1].shipinfenlei}}</div>
                </div>
			</div>
			<div v-if="jianmeicaoRecommend.length>2" @click="toDetail('jianmeicaoDetail', jianmeicaoRecommend[2])" class="list-item animation-box" :style='{"width":"48%","margin":"0","position":"relative","display":"inline-block","height":"100%"}'>
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-if="preHttp(jianmeicaoRecommend[2].fengmian)" :src="jianmeicaoRecommend[2].fengmian.split(',')[0]" alt="" />
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-else :src="baseUrl + (jianmeicaoRecommend[2].fengmian?jianmeicaoRecommend[2].fengmian.split(',')[0]:'')" alt="" />
				<div class="title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","left":"0","textAlign":"center","bottom":"0","background":"rgba(0,0,0,.3)","width":"100%","lineHeight":"32px","fontSize":"14px","position":"absolute","textOverflow":"ellipsis"}'>
                    <div>{{jianmeicaoRecommend[2].shipinbiaoti}}</div>
                    <div>{{jianmeicaoRecommend[2].shipinfenlei}}</div>
                </div>
			</div>
		</div>
		<div class="list-body" :style='{"width":"48%","margin":"10px 0 0","float":"left","justifyContent":"space-between","display":"flex","height":"275px"}'>
			<div v-if="jianmeicaoRecommend.length>3" @click="toDetail('jianmeicaoDetail', jianmeicaoRecommend[3])" class="list-item animation-box" :style='{"width":"48%","margin":"0","position":"relative","display":"inline-block","height":"100%"}'>
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-if="preHttp(jianmeicaoRecommend[3].fengmian)" :src="jianmeicaoRecommend[3].fengmian.split(',')[0]" alt="" />
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-else :src="baseUrl + (jianmeicaoRecommend[3].fengmian?jianmeicaoRecommend[3].fengmian.split(',')[0]:'')" alt="" />
				<div class="title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","left":"0","textAlign":"center","bottom":"0","background":"rgba(0,0,0,.3)","width":"100%","lineHeight":"32px","fontSize":"14px","position":"absolute","textOverflow":"ellipsis"}'>
                    <div>{{jianmeicaoRecommend[3].shipinbiaoti}}</div>
                    <div>{{jianmeicaoRecommend[3].shipinfenlei}}</div>
                </div>
			</div>
			<div v-if="jianmeicaoRecommend.length>4" @click="toDetail('jianmeicaoDetail', jianmeicaoRecommend[4])" class="list-item animation-box" :style='{"width":"48%","margin":"0","position":"relative","display":"inline-block","height":"100%"}'>
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-if="preHttp(jianmeicaoRecommend[4].fengmian)" :src="jianmeicaoRecommend[4].fengmian.split(',')[0]" alt="" />
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-else :src="baseUrl + (jianmeicaoRecommend[4].fengmian?jianmeicaoRecommend[4].fengmian.split(',')[0]:'')" alt="" />
				<div class="title line1" :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#fff","left":"0","textAlign":"center","bottom":"0","background":"rgba(0,0,0,.3)","width":"100%","lineHeight":"32px","fontSize":"14px","position":"absolute","textOverflow":"ellipsis"}'>
                    <div>{{jianmeicaoRecommend[4].shipinbiaoti}}</div>
                    <div>{{jianmeicaoRecommend[4].shipinfenlei}}</div>
                </div>
			</div>
		</div>
	</div>
...
<div class="news" :style='{"width":"56%","margin":"0 7%","position":"relative","flexWrap":"wrap","background":"none","display":"flex"}'>
	...
	<div class="title" :style='{"margin":"30px auto 20px","alignItems":"center","textAlign":"center","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"flex-start","height":"50px"}'>
		<span :style='{"fontSize":"32px","lineHeight":"60px","color":"#202020","fontWeight":"bold","height":"60px"}'> 健美操资讯</span>
	</div>
  ...
  export default {
    ...
    methods: {
      ...
      getSystemIntroduction() {
		...
		getList() {
          let autoSortUrl = "";
          autoSortUrl = "jianmeicao/autoSort";
          if(localStorage.getItem('Token')) {
              autoSortUrl = "jianmeicao/autoSort2";
          }
			this.$http.get(autoSortUrl, {params: {
				...
				if (res.data.code == 0) {
					this.jianmeicaoRecommend = res.data.data.list;
